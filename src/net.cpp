...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Buxcoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"node1.buxcoin.eu", "node1.buxcoin.eu"},
    {"node2.buxcoin.eu", "node2.buxcoin.eu"},
    {"node3.buxcoin.eu", "node3.buxcoin.eu"},
    {"node4.buxcoin.eu", "node4.buxcoin.eu"},
    {"node5.buxcoin.eu", "node5.buxcoin.eu"},
    {"node6.buxcoin.eu", "node6.buxcoin.eu"},
    {"node7.buxcoin.eu", "node7.buxcoin.eu"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Buxcoin is probably already running."), addrBind.ToString());
        else
