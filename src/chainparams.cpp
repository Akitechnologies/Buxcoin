...
public:
    CMainParams() {
		...
		vSeeds.push_back(CDNSSeedData("seed5", "45.77.105.89"));
		vSeeds.push_back(CDNSSeedData("seed6", "45.76.120.83"));
		vSeeds.push_back(CDNSSeedData("seed7", "45.77.9.72"));
...
public:
    CTestNetParams() {
        ...
        base58Prefixes[SCRIPT_ADDRESS] = list_of(186);
